      ...
      <div class="form-container log-in-container">
        <form id="form1" runat="server">
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/teamleads.aspx" Text="View TeamLeads" Value="View TeamLeads"></asp:MenuItem>
      ...
      <div class="overlay-container">
        <div class="overlay">
          <div class="overlay-panel overlay-right">
            <h1>Manager Login</h1>
            <p>
              Manager ID : <asp:Label ID="ManagerIdLabel" runat="server" Text=""></asp:Label>
            </p>
          </div>
        </div>
      </div>
